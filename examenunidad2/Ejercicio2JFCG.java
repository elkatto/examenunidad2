...
public class Ejercicio2JFCG {
    ...
    public static void impuestocarros() {
        ...
        while (hayMas.equals("S")) {
            ...
            hayMas= String.valueOf(leer.next().toUpperCase().charAt(0));    
        }
